...
public class ZkLock implements AsyncCallback.StringCallback , AsyncCallback.Children2Callback, Watcher, Closeable {
    ...
    private static final ZooKeeper zooKeeper = new InitZookeeper().getZk();
    private String catalog = "/zk_lock_";
    ...
    public synchronized void unLock() {
        ...
        try {
            zooKeeper.delete(catalog.concat("/" + lockSeqName), -1);
    ...
    public static class InitZookeeper{
        ...
        private String address = "localhost:2181,localhost:2182,localhost:2183";
        ...
        public ZooKeeper getZk() {
            ...
            try {
                ...
                ZooKeeper zooKeeper = new ZooKeeper(address, sessionTimeout, watcher);
                downLatch.await();
                return zooKeeper;
            } catch (Exception e) {
